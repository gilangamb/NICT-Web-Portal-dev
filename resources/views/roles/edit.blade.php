...
@section("title") Edit Role & Permission @endsection
@section("pageTitle") Edit Role & Permission @endsection
...
<div class="col-md-12">
    ...
    <form enctype="multipart/form-data"
        ...
        type="checkbox" {{ in_array("CREATE", json_decode($role->type->intranet_admin)) ? "checked" : ""}}
        name="intranet_admin[]"
        id="ADMIN_CREATE"
        value="CREATE">
        ...
        <input class="form-control {{$errors->first('intranet_admin') ? "is-invalid" : "" }}"
            type="checkbox" {{ in_array("READ", json_decode($role->type->intranet_admin)) ? "checked" : ""}}
            name="intranet_admin[]"
            id="ADMIN_READ"
            value="READ">
        ...
        <input class="form-control {{$errors->first('intranet_admin') ? "is-invalid" : "" }}"
            type="checkbox" {{ in_array("UPDATE", json_decode($role->type->intranet_admin)) ? "checked" : ""}}
            name="intranet_admin[]"
            id="ADMIN_UPDATE"
            value="UPDATE">
        ...
        <input class="form-control {{$errors->first('intranet_admin') ? "is-invalid" : "" }}"
        type="checkbox" {{ in_array("DELETE", json_decode($role->type->intranet_admin)) ? "checked" : ""}}
        name="intranet_admin[]" 
        id="ADMIN_DELETE" 
        value="DELETE">
        ...
        <input class="form-control {{$errors->first('intranet_admin') ? "is-invalid" : "" }}"
        type="checkbox" {{ in_array("INDEX", json_decode($role->type->intranet_admin)) ? "checked" : ""}}
        name="intranet_admin[]" 
        id="ADMIN_INDEX" 
        value="INDEX">
        ...
        type="checkbox" {{ in_array("CREATE", json_decode($role->type->layanan_fasilitas)) ? "checked" : ""}}
        ...
        <input class="form-control {{$errors->first('layanan_fasilitas') ? "is-invalid" : "" }}"
            type="checkbox" {{ in_array("READ", json_decode($role->type->layanan_fasilitas)) ? "checked" : ""}}
            name="layanan_fasilitas[]"
            id="LAYANAN_READ"
            value="READ">
        ...
        <input class="form-control {{$errors->first('layanan_fasilitas') ? "is-invalid" : "" }}"
            type="checkbox" {{ in_array("UPDATE", json_decode($role->type->layanan_fasilitas)) ? "checked" : ""}}
            name="layanan_fasilitas[]"
            id="LAYANAN_UPDATE"
            value="UPDATE">
        ...
        <input class="form-control {{$errors->first('layanan_fasilitas') ? "is-invalid" : "" }}"
        type="checkbox" {{ in_array("DELETE", json_decode($role->type->layanan_fasilitas)) ? "checked" : ""}}
        name="layanan_fasilitas[]" 
        id="LAYANAN_DELETE" 
        value="DELETE">
        ...
        <input class="form-control {{$errors->first('layanan_fasilitas') ? "is-invalid" : "" }}"
        type="checkbox" {{ in_array("INDEX", json_decode($role->type->layanan_fasilitas)) ? "checked" : ""}}
        name="layanan_fasilitas[]" 
        id="LAYANAN_INDEX" 
        value="INDEX">
        ...
        <input class="form-control {{$errors->first('internship') ? "is-invalid" : "" }}"
            type="checkbox" {{ in_array("CREATE", json_decode($role->type->internship)) ? "checked" : ""}}
            name="internship[]"
            id="INTERN_CREATE"
            value="CREATE">
        ...
        <input class="form-control {{$errors->first('internship') ? "is-invalid" : "" }}"
            type="checkbox" {{ in_array("READ", json_decode($role->type->internship)) ? "checked" : ""}}
            name="internship[]"
            id="INTERN_READ"
            value="READ">
        ...
        <input class="form-control {{$errors->first('internship') ? "is-invalid" : "" }}"
            type="checkbox" {{ in_array("UPDATE", json_decode($role->type->internship)) ? "checked" : ""}}
            name="internship[]"
            id="INTERN_UPDATE"
            value="UPDATE">
        ...
        <input class="form-control {{$errors->first('internship') ? "is-invalid" : "" }}"
        type="checkbox" {{ in_array("DELETE", json_decode($role->type->internship)) ? "checked" : ""}}
        name="internship[]" 
        id="INTERN_DELETE" 
        value="DELETE">
        ...
        <input class="form-control {{$errors->first('internship') ? "is-invalid" : "" }}"
        type="checkbox" {{ in_array("INDEX", json_decode($role->type->internship)) ? "checked" : ""}}
        name="internship[]" 
        id="INTERN_INDEX" 
        value="INDEX">
        ...
        <input class="form-control {{$errors->first('keuangan') ? "is-invalid" : "" }}"
            type="checkbox" {{ in_array("CREATE", json_decode($role->type->keuangan)) ? "checked" : ""}}
            name="keuangan[]"
            id="UANG_CREATE"
            value="CREATE">
        ...
        <input class="form-control {{$errors->first('keuangan') ? "is-invalid" : "" }}"
            type="checkbox" {{ in_array("READ", json_decode($role->type->keuangan)) ? "checked" : ""}}
            name="keuangan[]"
            id="UANG_READ"
            value="READ">
        ...
        <input class="form-control {{$errors->first('keuangan') ? "is-invalid" : "" }}"
            type="checkbox" {{ in_array("UPDATE", json_decode($role->type->keuangan)) ? "checked" : ""}}
            name="keuangan[]"
            id="UANG_UPDATE"
            value="UPDATE">
        ...
        <input class="form-control {{$errors->first('keuangan') ? "is-invalid" : "" }}"
        type="checkbox" {{ in_array("DELETE", json_decode($role->type->keuangan)) ? "checked" : ""}}
        name="keuangan[]" 
        id="UANG_DELETE" 
        value="DELETE">
        ...
        <input class="form-control {{$errors->first('keuangan') ? "is-invalid" : "" }}"
        type="checkbox" {{ in_array("INDEX", json_decode($role->type->keuangan)) ? "checked" : ""}}
        name="keuangan[]" 
        id="UANG_INDEX" 
        value="INDEX">
        ...
        <input class="form-control {{$errors->first('kepegawaian') ? "is-invalid" : "" }}"
            type="checkbox" {{ in_array("CREATE", json_decode($role->type->kepegawaian)) ? "checked" : ""}}
            name="kepegawaian[]"
            id="PEGAWAI_C"
            value="CREATE">
        ...
        <input class="form-control {{$errors->first('kepegawaian') ? "is-invalid" : "" }}"
            type="checkbox" {{ in_array("READ", json_decode($role->type->kepegawaian)) ? "checked" : ""}}
            name="kepegawaian[]"
            id="PEGAWAI_R"
            value="READ">
        ...
        <input class="form-control {{$errors->first('kepegawaian') ? "is-invalid" : "" }}"
            type="checkbox" {{ in_array("UPDATE", json_decode($role->type->kepegawaian)) ? "checked" : ""}}
            name="kepegawaian[]"
            id="PEGAWAI_U"
            value="UPDATE">
        ...
        <input class="form-control {{$errors->first('kepegawaian') ? "is-invalid" : "" }}"
        type="checkbox" {{ in_array("DELETE", json_decode($role->type->kepegawaian)) ? "checked" : ""}}
        name="kepegawaian[]" 
        id="PEGAWAI_D" 
        value="DELETE">
        ...
        <input class="form-control {{$errors->first('kepegawaian') ? "is-invalid" : "" }}"
        type="checkbox" {{ in_array("INDEX", json_decode($role->type->kepegawaian)) ? "checked" : ""}}
        name="kepegawaian[]" 
        id="PEGAWAI_I" 
        value="INDEX">
        ...
        <input class="form-control {{$errors->first('aset_bmn') ? "is-invalid" : "" }}"
            type="checkbox" {{ in_array("CREATE", json_decode($role->type->aset_bmn)) ? "checked" : ""}}
            name="aset_bmn[]"
            id="ASET_C"
            value="CREATE">
        ...
        <input class="form-control {{$errors->first('aset_bmn') ? "is-invalid" : "" }}"
            type="checkbox" {{ in_array("READ", json_decode($role->type->aset_bmn)) ? "checked" : ""}}
            name="aset_bmn[]"
            id="ASET_R"
            value="READ">
        ...
        <input class="form-control {{$errors->first('aset_bmn') ? "is-invalid" : "" }}"
            type="checkbox" {{ in_array("UPDATE", json_decode($role->type->aset_bmn)) ? "checked" : ""}}
            name="aset_bmn[]"
            id="ASET_U"
            value="UPDATE">
        ...
        <input class="form-control {{$errors->first('aset_bmn') ? "is-invalid" : "" }}"
        type="checkbox" {{ in_array("DELETE", json_decode($role->type->aset_bmn)) ? "checked" : ""}}
        name="aset_bmn[]" 
        id="ASET_D" 
        value="DELETE">
        ...
        <input class="form-control {{$errors->first('aset_bmn') ? "is-invalid" : "" }}"
        type="checkbox" {{ in_array("INDEX", json_decode($role->type->aset_bmn)) ? "checked" : ""}}
        name="aset_bmn[]" 
        id="ASET_I" 
        value="INDEX">
        ...
        <input class="form-control {{$errors->first('surat_arsip') ? "is-invalid" : "" }}"
            type="checkbox" {{ in_array("CREATE", json_decode($role->type->surat_arsip)) ? "checked" : ""}}
            name="surat_arsip[]"
            id="SURAT_C"
            value="CREATE">
        ...
        <input class="form-control {{$errors->first('surat_arsip') ? "is-invalid" : "" }}"
            type="checkbox" {{ in_array("READ", json_decode($role->type->surat_arsip)) ? "checked" : ""}}
            name="surat_arsip[]"
            id="SURAT_R"
            value="READ">
        ...
        <input class="form-control {{$errors->first('surat_arsip') ? "is-invalid" : "" }}"
            type="checkbox" {{ in_array("UPDATE", json_decode($role->type->surat_arsip)) ? "checked" : ""}}
            name="surat_arsip[]"
            id="SURAT_U"
            value="UPDATE">
        ...
        <input class="form-control {{$errors->first('surat_arsip') ? "is-invalid" : "" }}"
        type="checkbox" {{ in_array("DELETE", json_decode($role->type->surat_arsip)) ? "checked" : ""}}
        name="surat_arsip[]" 
        id="SURAT_D" 
        value="DELETE">
        ...
        <input class="form-control {{$errors->first('surat_arsip') ? "is-invalid" : "" }}"
        type="checkbox" {{ in_array("INDEX", json_decode($role->type->surat_arsip)) ? "checked" : ""}}
        name="surat_arsip[]" 
        id="SURAT_I" 
        value="INDEX">
        ...
        <input class="form-control {{$errors->first('kms') ? "is-invalid" : "" }}"
            type="checkbox" {{ in_array("CREATE", json_decode($role->type->kms)) ? "checked" : ""}}
            name="kms[]"
            id="KMS_C"
            value="CREATE">
        ...
        <input class="form-control {{$errors->first('kms') ? "is-invalid" : "" }}"
            type="checkbox" {{ in_array("READ", json_decode($role->type->kms)) ? "checked" : ""}}
            name="kms[]"
            id="KMS_R"
            value="READ">
        ...
        <input class="form-control {{$errors->first('kms') ? "is-invalid" : "" }}"
            type="checkbox" {{ in_array("UPDATE", json_decode($role->type->kms)) ? "checked" : ""}}
            name="kms[]"
            id="KMS_U"
            value="UPDATE">
        ...
        <input class="form-control {{$errors->first('kms') ? "is-invalid" : "" }}"
        type="checkbox" {{ in_array("DELETE", json_decode($role->type->kms)) ? "checked" : ""}}
        name="kms[]" 
        id="KMS_D" 
        value="DELETE">
        ...
        <input class="form-control {{$errors->first('kms') ? "is-invalid" : "" }}"
        type="checkbox" {{ in_array("INDEX", json_decode($role->type->kms)) ? "checked" : ""}}
        name="kms[]" 
        id="KMS_I" 
        value="INDEX">
