...
<section class="jumbotron-bg">
    <div class="jumbotron warna-linear text-white">
        <div class="container">
            <h1 class="display-2 text-center">Agenda</h1>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="text-secondary"
                        style="font-size: 14px">by {{ $content->user->username }} as AGENDA <br> {{ \Carbon\Carbon::parse($content->updated_at)->format('l jS F Y') }}</p>
                    <p class="card-text">{!! Str::words($content->description, 20, ' ...') !!}</p>
                    <a href="{{ route('agenda.show', [$content->id]) }}" >Read more...</a>
                </div>
            </div>
        </div>
        @endforeach
